...
namespace fnGetAllMovies
{
    public  class Function1
    {
            ...
            ILogger log)
        {
            ...
            var results = await GetCosmos();

            await responseMessage.WriteAsJsonsAsync(results);

            return responseMessage;

        }
        private async Task<IEnumerable<MovieResult>> GetCosmos()
        {

            var connectionString = _configuration["Values:CosmosConnection"];
